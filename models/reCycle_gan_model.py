...
class ReCycleGANModel(BaseModel):
	...
	def backward_G(self):
		...
		self.loss_recycle_A = loss_recycle_A.item()
		self.loss_recycle_B = loss_recycle_B.item()
		self.loss_pred_A = loss_pred_A.item()
		self.loss_pred_B = loss_pred_B.item()

		self.loss_cycle_A = loss_cycle_A0.item() + loss_cycle_A1.item()
		self.loss_cycle_B = loss_cycle_B0.item() + loss_cycle_B1.item()
